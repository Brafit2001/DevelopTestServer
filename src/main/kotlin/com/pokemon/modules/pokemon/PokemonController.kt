...
class PokemonControllerImp: PokemonController, KoinComponent {
    ...
    override suspend fun searchPokemonById(pokemonId: Int): Pokemon = dbQuery {
        pokemonApi.getPokemonById(pokemonId) ?: throw PokemonNotFound()
    }

    override suspend fun searchPokemonByName(pokemonName: String): Pokemon = dbQuery {
        pokemonApi.getPokemonByName(pokemonName) ?: throw PokemonNotFound()
    }
...
interface PokemonController {
    suspend fun searchPokemonByName(pokemonName: String): Pokemon
    suspend fun searchPokemonById(pokemonId: Int): Pokemon
